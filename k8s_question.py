...
k8s_deployment_management_commands = [
...
k8s_service_management_commands = [
...
k8s_config_and_secret_management_commands = [
...
k8s_resource_management_commands = [
...
k8s_advanced_debugging_commands = [
